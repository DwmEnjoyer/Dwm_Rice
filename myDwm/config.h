...
static const unsigned int systrayonleft = 0;           /* 0: systray in the right corner, >0: systra>*/
...
static const char *fonts[]          = { "JetBrainsMono-Light:size=12", "TakaoGothic-Regular:size=12" };
static const char dmenufont[]       = "JetBrainsMono-Light:size=12";
